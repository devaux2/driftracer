...
export class Game {
  ...
  private setupEnvironment(): void {
    ...
    // A vast neon grid floor far below for parallax / sense of motion.
    const floor = MeshBuilder.CreateGround("floor", { width: 4000, height: 4000 }, this.scene);
    floor.position.y = -8;
